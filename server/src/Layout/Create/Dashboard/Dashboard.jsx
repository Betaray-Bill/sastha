    ...
    <div className="w-full p-14">
      <div className="flex gap-6">
        ...
        <Card className="flex-1">
          <CardHeader>
            <CardTitle>Create a Generator Type</CardTitle>
          </CardHeader>
          <CardContent>
                  ...
                  return (
                    <Card key={index} className="p-4">
                      ...
                      <Input
                        ...
                        value={item.content}
                        onChange={(e) =>
                          handleChange(e.target.value, "H1", index)
                        }
                        className="mt-2"
                      />
                    </Card>
                    ...
                    <Card key={index} className="p-4">
                      ...
                      <div className="flex items-start gap-2 mt-2">
                        <Input
                          ...
                          onChange={(e) =>
                            handleChange(e.target.value, "LIST", index)
                          }
                        />
                        ...
                        {item.content.listItems?.map((listItem, _i) => (
                          <li key={_i} className="flex items-center gap-2">
                            ...
                            <Input
                              ...
                              value={listItem}
                              onChange={(e) =>
                                handleChangeList(e.target.value, index, _i)
                              }
                            />
                            <Button
                              variant="ghost"
                              size="icon"
                              onClick={() => deleteList(index, _i)}
                            >
                              <Trash2 className="h-4 w-4 text-red-500" />
                            </Button>
                          </li>
                  ...
                  return (
                    <Card key={index} className="p-4">
                      ...
                      <Input
                        ...
                        value={item.content}
                        onChange={(e) =>
                          handleChange(e.target.value, "h2", index)
                        }
                        className="mt-2"
                      />
                    </Card>
                  ...
                  return (
                    <Card key={index} className="p-4">
                      ...
                      <Textarea
                        ...
                        value={item.content}
                        onChange={(e) =>
                          handleChange(e.target.value, "Paragraph", index)
                        }
                        className="mt-2"
                      />
                    </Card>
        ...
        <Card className="w-[300px] h-[fit-content]"> 
          <CardHeader>
