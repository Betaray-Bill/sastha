...
export async function generateStaticParams() {
    ...
    const generatorData = snapshot.docs.map((doc) => ({ id: doc.id, ...doc.data() }));
...
export async function generateMetadata({params}){
    ...
    const firestore = getFirestore();
    const docRef = firestore.collection("generator").doc(id);
    ...
    console.log(data)
    return {
        title: `${data.metaData.metaTitle} | Best Kirloskar Generators Dealer in Chennai`,
        description: data.metaData.metaDescription || "Explore our range of Kirloskar Generators from 2kVA to 200kVA.",
        keywords: data.metaData.metaKeywords || ["Diesel Generator", "Gas Generator", "Portable Generator"],
        openGraph: {
            ...
            url: `https://sasthapowerservices.com/generator/${id}`,
            site_name: "Sashtha Power Services",
            type: "article",
            images: data.images && data.images.length > 0 
            ? [{ url: data.images[0].src, alt: data.images[0].alt }] 
            : [{ url: "https://sasthapowerservices.com/default-generator.jpg", alt: "Kirloskar Generator - Best in Chennai" }]
        },
        canonical: `https://sasthapowerservices.com/generator/${id}`,
    };
...
export default async function Page({ params }) {
    ...
    const structuredData = {
        ...
        "image": data.images ? data.images[0].src : "https://sasthapowerservices.com/default-generator.jpg",
        "brand": {
            "@type": "Brand",
